...
Тело: {"error":{message,type,param,code}} (master §6.6). Маппинг кодов — решение U3
(spec 04): битый файл→400, лимиты→400/413, инструмент не найден→500, очередь→503,
auth→401, непредусмотренное→500. 415 не используется (OpenAI отдаёт 400).
"""
